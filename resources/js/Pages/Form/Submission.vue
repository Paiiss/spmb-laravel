                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    >
                        ...
                        <p>
                            ...
                            >, silahkan melakukan pendaftaran dengan mengisi
                            form pendaftaran.
                        </p>
                    </div>
                </div>
                                ...
                                >
                                    ...
                                    <li class="mb-10 ms-4">
                                        ...
                                        <p
                                            class="text-base font-normal text-gray-500 dark:text-gray-400"
                                        >
                                            Lengkapi data pendidikan terakhir
                                            pada menu
                                            <Link
                                                :href="
                                                    route('form.edit', {
                        ...
                        >
                            ...
                            <div class="shadow-md sm:shadow-lg p-4 sm:p-8">
                                ...
                                <div class="mt-4">
                                    ...
                                    >
                                        <li>
                                            Apabila pembayaran melalui setor
                                            tunai ke BANK BTN ataupun beda BANK,
                                            anda harus menuliskan kode
                                            pembayaran pada kolom "catatan" atau
                                            "berita untuk penerima" pada slip
                                            setoran
                                        </li>
                                        <li>
                                            Untuk pembayaran melalui mesin ATM
                                            harus mengupload struk transfer
                                            dengan menuliskan kode pembayaran
                                            pada struk tersebut
                                        </li>
                                        <li>
                                            Pembayaran dengan SMS BANKING tidak
                                            akan diverifikasi
                                        </li>
                                    </ul>
                                </div>
