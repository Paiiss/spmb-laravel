...
class HealthRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'is_smoking.boolean' => 'Merokok harus berupa boolean',
            'color_blind.boolean' => 'Buta warna harus berupa boolean',
            'is_disability.boolean' => 'Disabilitas harus berupa boolean',
